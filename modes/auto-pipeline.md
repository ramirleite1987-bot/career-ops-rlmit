...
If the input is a **URL** (not pasted JD text), use this priority order to extract the content:
...
1. **Extract form questions**: Use Playwright to navigate to the application form and take a snapshot. If unavailable, fall back to generic questions below.
...
- **Selective without elitism**: "I've been intentional about finding a team where I can contribute meaningfully from day one"
...
- **How did you hear?** → Honest: "Found it through [portal/scan], evaluated it against my criteria, and it ranked highest."
...
**If any step fails**, continue with the remaining steps and flag the failed step as pending in the tracker.
